...
public class UserAdapter extends RecyclerView.Adapter<UserAdapter.UserViewHolder> {
    ...
    private Data data; // Referensi ke MainActivity
    ...
    private void showDeleteConfirmationDialog(final int userId) {
        ...
        builder.setMessage("Anda Yakin ingin Mengghapus Data Ini?");
    ...
    public class UserViewHolder extends RecyclerView.ViewHolder {
        public TextView nik, nama, alamat, jk, agama;
        ...
        public UserViewHolder(View itemView) {
            ...
            jk = itemView.findViewById(R.id.textViewJk);
